...
if($_SESSION['login'])
{
	...
	$disabled = "<button class=\"disabled\" onclick=\"window.alert('" . SITE_NAME . " is currently closed. Sorry for this inconvenience!'); return false;\">" . SITE_NAME . " is currently closed</button>";
	
?>
		<?php echo Core::GetSystemStatus() == "1"? $enabled : $disabled; ?>
<?php
