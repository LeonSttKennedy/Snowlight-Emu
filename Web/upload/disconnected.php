...
<tr>
	<td valign="middle" style="text-align: center;">
		<img src="http://<?php echo SITE_DOMAIN; ?>/images/sadface.png">
	</td>
	<td valign="middle" style="float: right; padding: 25px;">
		...
		<h2>
			It appears you have been disconnected from Uber.
		</h2>
		
		<br />
		
		<h3>
			<a href="http://<?php echo SITE_DOMAIN; ?>/client.php">Reload client</a>
		</h3>
		...
		<h3>
			<a href="http://<?php echo SITE_DOMAIN; ?>/client.php">Log in again?</a>
		</h3>		
		<?php } ?>
